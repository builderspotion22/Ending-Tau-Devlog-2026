...
**Tracking curses, combat, and the jungle’s changing rules.**
...
Ending Tau is an action roguelike set in a pixel-art jungle shaped by procedural generation. Curses alter the player character’s body and change movement, combat, and exploration. The project is currently documented in pre-alpha development, with village rebuilding, boss encounters, and lore still being iterated.

This devlog is for players and developers interested in action roguelikes, procedural worlds, and iterative indie game development.
...
- 🧬 **Body-changing curses** — Curses alter movement, combat, and the way each run is played.
- 🌿 **Procedural jungle** — Runs move through changing landscapes filled with folkloric creatures.
- ⚔️ **Action combat** — Fast combat centers on dangerous encounters and large boss fights.
- 🏘️ **Village rebuilding** — Progress includes restoring a village and unlocking relics, skills, and allies.
- 🎨 **Pixel-art world** — The setting uses a stylized pixel-art presentation and a jungle-focused atmosphere.

## 📸 Screenshots

<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2087880/ss_42327971dee4ce492a9e97a3e7e39a0e8673e3b1.1920x1080.jpg?t=1784675972" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2087880/ss_485be7f20b060d40af03929da7b36ffd2e220444.1920x1080.jpg?t=1784675972" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2087880/ss_28998f42ab1c547bc9f3653f41fd62042370d07c.1920x1080.jpg?t=1784675972" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
|:--- |:--- |:--- |
| **OS** | Windows 7 | Windows 10 (x64) |
| **Processor** | 2.8 GHz processor | Intel Core i5 or equivalent |
| **RAM** | 4 GB | 8 GB |
| **Graphics** | Discrete video card | Dedicated GPU with 2 GB VRAM |
| **Storage** | 850 MB available space | 2 GB available space (SSD preferred) |
| **Additional** | Sound card | DirectX 11 |
